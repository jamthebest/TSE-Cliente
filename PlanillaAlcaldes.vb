Public Class PlanillaAlcaldes
    ...
    Private Sub FillCandidatos(ByVal [text] As String)
        ...
        Else
            ...
            For Each item As ArrayList In Me.items
                Dim candi As New Candidato(item.Item(1), item.Item(5), item.Item(4), Nothing, Me, Nothing, item.Item(3), item.Item(6))
    ...
    Private Sub PlanillaAlcaldes_Load(sender As Object, e As EventArgs) Handles MyBase.Load
