Public Class NuevoMunicipio
    ...
    Private Sub RespuestaCrearRegistro(ByVal respuesta As Solicitud) Handles WinSockCliente.RespuestaCrearRegistro
        ...
        If (respuesta.MensajeSolicitud = "Registro Creado!") Then
            MsgBox("Municipio Creado!", MsgBoxStyle.OkOnly)
            Me.demo = New Threading.Thread(New Threading.ThreadStart(AddressOf Me.ThreadProcSafe))
            Me.demo.Start()
        Else
            MsgBox("Error al Crear el Municipio", MsgBoxStyle.Critical, "Error")
        End If
    End Sub

    Private Sub NuevoMunicipio_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub cmdGuardar_Click(sender As Object, e As EventArgs) Handles cmdGuardar.Click
        ...
        Dim registro As New Registro("Municipio", hash)
